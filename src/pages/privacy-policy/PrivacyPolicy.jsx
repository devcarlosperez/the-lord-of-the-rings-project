      ...
      <div className="privacy-policy-content">
        ...
        <ul>
          ...
          <li>
            ...
            "Us" or "Our" in this Agreement) refers to Lord of The Rings.
          </li>
          <li>
          ...
          <li>
            <strong>Website</strong> refers to Lord of The Rings, accessible
            from https://lord-of-the-rings-4444a.web.app/
          </li>
          <li>
        ...
        <ul>
          ...
          <li>
            To contact You: By email, telephone, SMS, or other equivalent forms
            of communication.
          </li>
          <li>
          ...
          <li>
            For business transfers: We may use Your information for business
            evaluations.
          </li>
        </ul>
        ...
        <p>
          We may disclose Your Personal Data for business transactions, law
