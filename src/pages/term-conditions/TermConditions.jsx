  ...
  return (
    <>
      ...
      <div className="term-conditions-content">
        ...
        <ul>
          <li><strong>Service</strong> refers to the Website, "Lord of The Rings".</li>
          <li><strong>Company</strong> refers to Lord of The Rings.</li>
          <li><strong>Account</strong> refers to a unique account created for accessing the Service.</li>
          <li><strong>Terms</strong> means these Terms and Conditions.</li>
          <li><strong>You</strong> refers to the individual using the Service, or the company or entity on behalf of which the individual is using the Service.</li>
        </ul>
        ...
        <ul>
          ...
          <li>Not to use the Service for any unlawful purpose or in any way that could harm the Service or others.</li>
          <li>Respect the intellectual property rights of the Company and other users.</li>
        </ul>

        <h2>Account Registration</h2>
        <p>
          In order to use certain features of the Service, You may be required to
        ...
        <h2>Payment</h2>
        <p>
          If applicable, You agree to pay all fees associated with using the Service.
        </p>

        <h2>Prohibited Uses</h2>
        <p>
          You may not use the Service for any illegal or prohibited activities, including:
        </p>
        <ul>
